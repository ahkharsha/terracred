...
import 'package:terracred/model/contacts.dart';
...
class DatabaseService {
  ...
  // it will be used to create an instance of the DatabaseService class
  DatabaseService._createInstance();

  //Now lets create an instance of the database
  static DatabaseService? _DatabaseService; // this _DatabaseService will
  ...
  factory DatabaseService() {
    ...
    if (_DatabaseService == null) {
      //create an instance of _DatabaseService iff there is no instance created before
